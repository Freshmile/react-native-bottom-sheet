...
ScrollableComponent) {
  return /*#__PURE__*/(0, _react.forwardRef)((props, ref) => {
    ...
    const lastContentHeightRef = (0, _react.useRef)();
    //#endregion
    ...
    (0, _hooks.useScrollableSetter)(scrollableRef, type, scrollableContentOffsetY, lastContentHeightRef, onRefresh !== undefined, focusHook);
    //#endregion
